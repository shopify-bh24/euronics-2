...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-AW3QCINN.js"), { isDevelopment } = await import("./local-ZIKS25AW.js"), oclif = await import("./lib-2ZBT3UR2.js"), { ShopifyConfig } = await import("./custom-oclif-loader-BEAC6M5I.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-NKEN4MZY.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-T3RQZ6EF.js"), { moduleDirectory } = await import("./path-GB4VIEM6.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-YUXFQXPK.js.map
